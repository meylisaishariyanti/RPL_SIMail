...
<nav class="brown">
    <div class="nav-wrapper">
        <a href="./" class="brand-Logo center hide-on-large-only"><i class="material-icons md-36">school</i> FTI Mail</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
            <li class="no-padding">
                <div class="logo-side center brown">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">MTs Al-Khairaat Boroko</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Siswa No. 167 Boroko Timur</p>';
                            }
                        }
                    ?>
                </div>
            </li>
            <li class="no-padding brown">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> FTI Mail</a></li>
            <li><div class="grs"></></li>
